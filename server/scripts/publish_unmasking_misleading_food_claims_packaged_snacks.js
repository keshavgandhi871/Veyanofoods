 ...
 * This script inserts/updates the "Unmasking Misleading Food Claims: The New Era of Clean Snacking in India" blog post with July 4 citations.
 */
...
const blogData = {
  ...
  author: "Veyano Team",
  created_at: new Date("2026-07-04T10:00:00Z") // Updated specifically to 4 July 2026
};

async function publish() {
  console.log('🚀 Syncing local database and publishing updated misleading claims blog with July 4 citations...');
  try {
